...
- **[Ollama](providers/ollama.md)** - Local LLM and embedding inference
- **[OpenAI](providers/openai.md)** - Cloud GPT models and embeddings

## Advanced Features

- **[Embeddings](../api/EMBEDDING_GUIDE.md)** - Semantic search and vector operations
